...
//        configurePageControl()
    ...
    func setupToolbarAndNavigationbar () {
        ...
        let toolBarAttrImageClicked = [ NSAttributedStringKey.foregroundColor: UIColor(displayP3Red: 0, green: 122/255, blue: 1.0, alpha: 1.0),
                                 NSAttributedStringKey.font: UIFont.fontAwesome(ofSize: 30, style: .solid)]
        let toolBarAttrLabelClicked = [ NSAttributedStringKey.foregroundColor: UIColor(displayP3Red: 0, green: 122/255, blue: 1.0, alpha: 1.0),
                                 NSAttributedStringKey.font: UIFont(name: "Avenir Next", size: 10.0)!]
    ...
    @objc func shareFactAction(sender : UIButton) {
        ...
        var listOfCurrentFunFacts = ViewController.ListOfFunFacts(listOfFunFacts: [])
...
//        if let imageToShare = UIImage(named: landmark.listOfFunFacts[currentIndex].imageName) {
